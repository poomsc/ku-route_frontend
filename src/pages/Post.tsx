    ...
    return (
        <div className="white-bg py-5">
            ...
            >
                ...
                <div>
                    <div className='d-flex pl-3 pb-2 d-inline-flex'
                        style={{
                            fontFamily: "Roboto",
                            fontStyle: "normal",
                            fontWeight: "bold",
                        ...
                        โพสต์โดย  &nbsp; <img src={user_icon} className="mt-0" style={{
                                                                        padding:"2px" ,
                                                                        background:"#E4E6E7", 
                                                                        width:"25px", 
                                                                        height:"25px", 
                                                                        borderRadius: "50px"}}/> &nbsp;{postOwner} 
                ...
                <div className="d-flex py-3 pl-5 pb-5 mb-5"
                    style={{
                        color: "#525252",
                        fontFamily: "Roboto",
                        fontStyle: "normal",
                ...
                <div className="d-flex pb-4 px-3">
                    ...
                    (                       
                        ...
                        >
                            ...
                            >
                                {file[0].split('.')[1] == "pdf" ?
                                    <div className="d-block mx-auto"> <img src={pdf} style={{width: "111px", height: "111px"}} /> </div> 
                                    :
                                    <div className="d-block mx-auto"><img src={jpg} style={{width: "111px", height: "111px"}} /> </div> 
                                }
